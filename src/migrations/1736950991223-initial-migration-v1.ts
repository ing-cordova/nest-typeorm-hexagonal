...
export class InitialMigrationV11736950991223 implements MigrationInterface {
    name = 'InitialMigrationV11736950991223'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "region" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "created_at" TIMESTAMP DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_5f48ffc3af96bc486f5f3f3a6da" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sub_region" ("id" SERIAL NOT NULL, "region_id" integer, "name" character varying NOT NULL, "created_at" TIMESTAMP DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_ce80f6dcc9a4ac8324f48b10975" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "country" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "iso2" character varying NOT NULL, "iso3" character varying NOT NULL, "phone_code" character varying NOT NULL, "region_id" integer, "sub_region_id" integer, "currency" character varying NOT NULL, "currency_name" character varying NOT NULL, "currency_symbol" character varying NOT NULL, "nationality" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_2c5aa339240c0c3ae97fcc9dc4c" UNIQUE ("name"), CONSTRAINT "UQ_b49a3cfa4a8ab50b388f893cd4c" UNIQUE ("iso2"), CONSTRAINT "UQ_8df5b1a0131e8e155381547aa5b" UNIQUE ("iso3"), CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "sub_region" ADD CONSTRAINT "FK_8f18e24ed62c0d96fe17c7aff6a" FOREIGN KEY ("region_id") REFERENCES "region"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "country" ADD CONSTRAINT "FK_d3a3d3f783d02360c61f2df1e43" FOREIGN KEY ("sub_region_id") REFERENCES "sub_region"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "country" DROP CONSTRAINT "FK_d3a3d3f783d02360c61f2df1e43"`);
        await queryRunner.query(`ALTER TABLE "country" DROP CONSTRAINT "FK_b1aac8314662fa6b25569a575bb"`);
        await queryRunner.query(`ALTER TABLE "sub_region" DROP CONSTRAINT "FK_8f18e24ed62c0d96fe17c7aff6a"`);
        ...
        await queryRunner.query(`DROP TABLE "sub_region"`);
